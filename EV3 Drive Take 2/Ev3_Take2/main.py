...
while event:
    ...
    meddown = scale(left_trigger, (0,255), (100,-100))
    medup = scale(right_trigger, (0, 255), (100,-100))
    ...
    med_motor.dc(medup - meddown)
    med_motor.dc(meddown + medup)
